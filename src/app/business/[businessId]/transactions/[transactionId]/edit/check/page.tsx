    ...
    return (
        <div className="w-full flex justify-center !px-4 !pt-24 h-screen">
            <div className="w-full max-w-lg mx-auto bg-background text-foreground !rounded-lg shadow flex flex-col">
                ...
                {/* Header (Fixed) */}
                <div className="!p-6 border-b relative w-full flex items-start">
                    <div
                        onClick={handleDelete}
                        className="absolute right-6 top-6 text-danger cursor-pointer"
                    >
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <DatePicker
                                calendar={persian}
                                locale={persian_fa}
                                value={dayjs(form.receiveDate)
                                    .calendar("jalali")
                                    .toDate()}
                                onChange={(d) =>
                                    setForm({
                                        ...form,
                                        receiveDate: dayjs(d.toDate()).toISOString(),
                                    })
                                }
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <DatePicker
                                ...
                                onChange={(d) =>
                                    setForm({
                                        ...form,
                                        dueDate: dayjs(d.toDate()).toISOString(),
                                    })
                                }
                                className="w-full border rounded-md px-3 py-2"
                            />
                        ...
                        {form.documentId && (
                            <div className="flex items-center gap-3">
                                <TransactionDocument
                                    docId={form.documentId}
                                    transactionTitle="نمایش چک"
                                />
                            </div>
                        )}
